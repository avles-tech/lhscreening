<!-- <?php $patient_reports = $this->patient_reports_model->get_patient_reports($patient_id); 
	if (!empty($patient_reports[$report])) :
        echo '<a class="btn btn-primary" role="button" href="'.base_url().'upload/download/'.$patient_reports[$report].'">'.$patient_reports[$report].'</a>';
...
<?php $patient_reports = $this->patient_reports_model->get_patient_reports($patient_id); 
	if (!empty($patient_reports[$report])) :
        echo "<a class='btn btn-primary btn-group mr-2'  role='button' href='".base_url()."upload/download/".$patient_reports[$report]."'>".$patient_reports[$report]."</a>";
